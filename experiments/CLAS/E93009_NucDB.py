...
def ExtractFromClasDat(lines,fname) :
    ...
    #annoyingly this save is needed because when the function exits the scope it deletes everything created here
    #experiment.Print()
...
if __name__ == "__main__":
    ...
    for i in range(1,306) : 
        ...
        ####### copied function from above in order to avoid annoying write to disk which slows everything down.
        lines = nlines
        fname = datfile
        dir          = "experiments/CLAS/"
        datafilename = dir + fname
