Int_t CCFR_NucDB(){
   ...
   NucDBReference * ref = new NucDBReference("CCFR-dimuon","Precise measurement of dimuon production cross-sections in muon neutrino Fe and muon anti-neutrino Fe deep inelastic scattering at the Tevatron");
