Int_t ratio_E155NH3(){
   ...
   exp = dbman->GetExperiment("SLAC-E155");
   if(!exp ) {
      exp = new NucDBExperiment("SLAC-E155","SLAC E155");
   }
   ...
   std::ifstream file("experiments/inclusive/positron_electron_ratio/data_output/SLAC_E155NH3.dat");
   ...
   while( !(file.eof()) ){
      for(int i = 0; i< 10;i++){
         file >> xcol[i] ;
         std::cout << "xcol[" << i << "] = " << xcol[i] << std::endl;
      }
