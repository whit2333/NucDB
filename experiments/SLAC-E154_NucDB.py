...
Xbjorken = NucDBBinnedVariable("x","x")
Qsq = NucDBBinnedVariable("Qsquared","Q^{2}")
A1nExtractor.fCurrentDataPoint.fBinnedVariables.Add(Xbjorken)
A1nExtractor.fCurrentDataPoint.fBinnedVariables.Add(Qsq)
...
Xbjorken = NucDBBinnedVariable("x","x")
Qsq = NucDBBinnedVariable("Qsquared","Q^{2}")
g2nExtractor.fCurrentDataPoint.fBinnedVariables.Add(Xbjorken)
g2nExtractor.fCurrentDataPoint.fBinnedVariables.Add(Qsq)
...
Xbjorken = NucDBBinnedVariable("x","x")
Qsq = NucDBBinnedVariable("Qsquared","Q^{2}")
A2nExtractor.fCurrentDataPoint.fBinnedVariables.Add(Xbjorken)
A2nExtractor.fCurrentDataPoint.fBinnedVariables.Add(Qsq)
