...
IF (WIN32)
   ...
   MESSAGE(STATUS " win32here ${MYSQL_LIB}")
ELSE (WIN32)
   ...
   #   /opt/mysql/lib/mysql)
   set(MYSQL_LIB /usr/lib/mysql/libmysqlclient_r.so)
   #MESSAGE(STATUS "here ${MYSQL_LIB}")
ENDIF (WIN32)
