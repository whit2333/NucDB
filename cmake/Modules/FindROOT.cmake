...
MACRO (ROOT_GENERATE_DICTIONARY INFILES LINKDEF_FILE OUTFILE INCLUDE_DIRS_IN)
  ...
  if(NOT PROJECT_USE_ROOT6)
    SET (OUTFILES ${OUTFILE} ${bla})
  else(NOT PROJECT_USE_ROOT6)
    SET (OUTFILES ${OUTFILE} )
  endif(NOT PROJECT_USE_ROOT6)

  #get_filename_component(path_name ${OUTFILE} PATH)
  #get_filename_component(file_extension ${OUTFILE} EXT)
  #get_filename_component(file_name ${OUTFILE} NAME_WE)
  #SET (OUTFILES ${OUTFILES} "${path_name}/${file_name}.h")
